	    		   ...
	    		   if(scope.search.gender!=undefined && scope.search.caste!=undefined)
	    			   {
								...
								response
								  .then(function(resp1){										
										if(resp1.data[0].userObject.id!=undefined)
										  {
											scope.nosimilarProfile=false;
											scope.similarProfile=true;
											rootscope.userDetailssMatch=resp1.data;
										 
										  }
										else 
											{
											scope.similarProfile=false;
											scope.nosimilarProfile=true;
											rootscope.noSimilarProfile="No Profile Matched";
											}
